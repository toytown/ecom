...
public class AddRealStateInfoPage extends GenericTemplatePage {
    ...
    public AddRealStateInfoPage() {
        ...
        wizardModel.add(new BasicInfoStep(new Model<String>("Provide Basic Info ...2"), null, realStateObjId));
        wizardModel.add(new ImageUploadStep(new Model<String>("Upload Images...3"), null, realStateObjId));
